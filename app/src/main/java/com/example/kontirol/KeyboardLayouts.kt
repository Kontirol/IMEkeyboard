    ...
    val UYGHUR = KeyboardLayout(
        ...
        rows = listOf(
            ...
            listOf(
                uk(0x06BE, "ھ"),
                uk(0x0633, "س"),
                uk(0x062F, "د", 0x0698, "ژ"),   // د 长按→ژ
                uk(0x0627, "ا", 0x0641, "ف"),   // ا 长按→ف
                uk(0x06D5, "ە", 0x06AF, "گ"),   // ە 长按→گ
                uk(0x0649, "ى", 0x062E, "خ"),   // ى 长按→خ
                uk(0x0642, "ق", 0x062C, "ج"),   // ق 长按→ج
                uk(0x0643, "ك", 0x06C6, "ۆ"),   // ك 长按→ۆ
                uk(0x0644, "ل")
            ),
            // 第三行
            listOf(
